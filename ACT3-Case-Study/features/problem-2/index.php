...
<body class="flex justify-center w-full h-screen p-4 ">
    ...
    <div class="flex flex-col space-y-4">
        <a href="/home" class="flex items-center space-x-4 hover:underline">
            ...
            Back to home</a>
        <h2 class="text-2xl font-bold">Problem 2</h2>
        <hr>
        <p>
            ...
            <div class="flex flex-col p-4 space-y-4 bg-blue-500 rounded-lg shadow-md">
                ...
                <form id="calculator-form" class="flex flex-col space-y-4">
                    ...
                    <div class="flex justify-center w-full space-x-4">
                        <input required name='firstNumber' value="0" type="number" id="first-number-input" class="p-2 transition duration-300 rounded-lg focus:outline-none focus:ring-1 ring-blue-300 " placeholder="Enter first number">
                        ...
                        <input required name="secondNumber" value="0" type="number" id="second-number-input" class="p-2 transition duration-300 rounded-lg focus:outline-none focus:ring-1 ring-blue-300 " placeholder="Enter second number">
                    </div>
